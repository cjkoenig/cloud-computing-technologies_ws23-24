...
# static information for metric
metrics.info('app_info', 'Metrics provided from the Page Hit Counter Webapplication', version='0.0.1')
...
@metrics.counter('site_invocations', 'Number of page hits', labels={'page_counter': counter})
def count():
